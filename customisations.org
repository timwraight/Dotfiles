...
*** ido
#+begin_src emacs-lisp
(setq ido-file-extensions-order '(".org" ".py" ".rc"))
#+end_src
*** Python
#+begin_src emacs-lisp
(require 'pony-mode)
...
#+begin_src emacs-lisp
  ...
  (setq org-export-latex-default-class "memarticle")
...
*** Miscellaneous
#+begin_src emacs-lisp
; Set right alt key to be normal Mac modifier key
(setq mac-right-option-modifier nil)
(set-face-attribute 'default nil :height 140)
(speedbar t)
 (global-set-key (kbd "C-S-s") 'speedbar-get-focus)
...
#+begin_src emacs-lisp
  ;; Line-spacing tweak (Optimized for Menlo)
